...
app.get('/health', (_: express.Request, res: express.Response): express.Response => {
  return res.json({ status: 'ok', service: 'auth-service' });
});

// Error handling middleware
app.use((err: any, req: express.Request, res: express.Response, next: express.NextFunction): express.Response => {
