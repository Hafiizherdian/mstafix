...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log(`Mengarahkan pengguna dengan role ${data.user.role} ke ${redirectPath}`);
      
      // Redirect ke halaman yang sesuai dengan langsung menggunakan window.location untuk memastikan
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-zinc-500 mt-2">
              Admin pertama kali?{' '}
              <Link href="/setup-admin" className="font-medium text-purple-500 hover:text-purple-400">
                Setup akun admin
              </Link>
            </p>
          </div>
